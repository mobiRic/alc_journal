 ...
 * lead to a {@link JournalEntryDetailActivity} representing
...
public class JournalEntryListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.journalentry_detail_container) != null) {
        ...
        View recyclerView = findViewById(R.id.journalentry_list);
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final JournalEntryListActivity mParentActivity;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(JournalEntryDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(JournalEntryDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(JournalEntryListActivity parent,
